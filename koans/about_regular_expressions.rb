...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_question_mark_means_optional # optional symbol. it may stay or may be left aboard
  ...
  #
  # Why?
  # they grip as much symbols as they could take
  ...
  # searches for the first inclusion
  ...
  def test_caret_anchors_to_the_start_of_lines
    assert_equal "2", "num 42\n2 lines"[/^\d+/] # /n is ont included in the resulting string
  end
  ...
  def test_sub_is_like_find_and_replace
    ...
    # take substring  $1, extract 1 symbol in position 0
    # and substitute the $1 substring with it
  end
