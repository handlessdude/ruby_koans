...
class AboutSymbols < Neo::Koan
  ...
  # you cannot compare symbol and string as the symbol is just number obscured by some name
  ...
  #
  # They are only put into memory once, making them very efficient to use for things like keys in hashes but they stay in memory until the program exits.
